...
@author: AMD_PC
"""
from testfunction import normal, ln_normal, plus, minus, ln_plus, ln_minus, divide, ln_divide
import numpy as np
import pandas as pd
from scipy.stats import stats
number = int(input("特徵方程式的數量(整數):"))
...
def testa():
    ...
    # 查看前幾高的參數  +1 是為了要加highest的原因
    print("前幾高pearson", data.nlargest(number+1))
